      ...
      def self.config
        {
         ...
         "URIBL"=>
          {"127.0.0.1"=>nil,
            "127.0.0.4"=>
            "Address found in UBE/UCE, and probably honour opt-out requests",
           :domain=>"multi.uribl.com",
           :type=>:domain,
           :disabled=>true,
           "127.0.0.8"=>
            "Address not listed on black and are either very young (domain age via whois), or use whois privacy features to protect their identity.",
         ...
         "SORBS"=>
          {"127.0.0.3"=>"Open SOCKS Proxy Servers",
           ...
           "127.0.0.12"=>
            "domain names where the owners have indicated no mail should ever be sent with these domains",
           "127.0.0.5"=>"Open SMTP Relays",
           "127.0.0.6"=>"Spam Sources",
           :domain=>"dnsbl.sorbs.net",
           "127.0.0.7"=>
            "web (WWW) server which have spammer abused vulnerabilities (e.g. FormMail scripts)",
           :type=>:ip,
         ...
         "FIVETENSG"=>
          {:domain=>"blackholes.five-ten-sg.com",
           ...
           "127.0.0.12"=>"free",
           "127.0.0.13"=>"cr"},
         "INPS"=>{:domain=>"dnsbl.inps.de", :type=>:ip, "127.0.0.2"=>"Blacklisted"},
         "MANITU"=>
          {:domain=>"ix.dnsbl.manitu.net", :type=>:ip, "127.0.0.2"=>"Blacklisted"},
         "NOMOREFUN"=>
         ...
         "SPAMCANNIBAL"=>
          {:domain=>"bl.spamcannibal.org", :type=>:ip, "127.0.0.2"=>"Blacklisted"},
         "UCEPROTECT1"=>
         ...
         "UCEPROTECT3"=>
          {:domain=>"dnsbl-3.uceprotect.net",
           ...
           "127.0.0.2"=>"Blacklisted"},
         "WHITELIST"=>
          {:domain=>"ips.whitelisted.org", :type=>:ip, "127.0.0.2"=>"Whitelisted"},
         "BACKSCATTERER"=>
